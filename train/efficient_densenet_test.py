...
def demo(data, save, depth=100, growth_rate=12, efficient=True, valid_size=121,
         n_epochs=25, batch_size=7, seed=None):
    """
    ...
    # Datasets
    train_set = datasets.ImageFolder(os.path.join(data, 'train'), train_transforms)
    test_set = datasets.ImageFolder(os.path.join(data, 'val'), test_transforms)
    ...
    if valid_size:
        # valid_set = datasets.ImageFolder(os.path.join(data, 'val'), train=True, transform=test_transforms)
...
if __name__ == '__main__':
    demo(data="/Users/peipengfei/Downloads/hymenoptera_data",save="/Users/peipengfei/Downloads/hymenoptera_data")